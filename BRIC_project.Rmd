...
#3 delete values with negative book value
...
#we keep: Id, country, ICBSUC, YEAR, BookValue and some other factors
# Note: WC07201 is not used, as our MV should be the MV from the monthly data for 06.y !
BRIC.yearly <- subset( BRIC.yearly, select = c("Id","country","ICBSUC","YEAR","BookValue","WC03501","WC01001","WC01051","WC01101","WC01251","WC02999","WC03263") )

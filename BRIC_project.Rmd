...
! run this chunk fully, when not editing code !
```{r}
# 8.4.1 STRATEGY ----
...
overview_strategy <- ggplot(data = evolution, aes(x = ym)) + 
  ...
  labs(y= "country weight", x = "ym", title ="country weights by value in startegy") + # x and y axis lables and plot title
  theme(plot.title = element_text(face="bold", hjust=0.5)) +
  scale_colour_manual(name="Country weight", 
...
overview_benchmark <- ggplot(data = evolution, aes(x = ym)) + 
  ...
  geom_line(aes(y = IND, colour="IND")) + 
  geom_line(aes(y = RUS, colour="RUS")) + 
  labs(y= "country weight", x = "ym", title ="country weights by value in benchmark") + # x and y axis lables and plot title
  theme(plot.title = element_text(face="bold", hjust=0.5)) +
  scale_colour_manual(name="Country weight", 
                      breaks = c("BRA", "CHN", "IND", "RUS"),
                      values = c("red", "green", "blue","orange"))
